...
<div class="container mx-auto mt-10 px-4">
    <h1 class="text-3xl font-bold mb-5 text-center">Zarządzaj Kategoriami</h1>
    <div class="flex justify-between mb-5">
        <a href="{{ route('categories.create') }}" class="bg-blue-500 text-white px-4 py-2 rounded shadow hover:bg-blue-600">Dodaj Kategorię</a>
    </div>
                    ...
                    <tr class="border-b border-gray-200 hover:bg-gray-100">
                        ...
                        <td class="py-3 px-6 text-center">
                            <div class="flex item-center justify-center">
                                ...
                                <form action="{{ route('categories.destroy', $category->id) }}" method="POST" onsubmit="return confirm('Czy na pewno chcesz usunąć tę kategorię?')">
                                    @csrf
                                    @method('DELETE')

...
<div class="container mx-auto mt-10 px-4">
    <h1 class="text-3xl font-bold mb-5 text-center">Edytuj Użytkownika</h1>
    @if ($errors->any())
    ...
    <div class="bg-white shadow-md rounded my-6 p-6">
        <form action="{{ route('admin.users.update', $user->id) }}" method="POST">
            ...
            <div class="flex justify-end">
                <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded shadow hover:bg-blue-600">Zaktualizuj Użytkownika</button>
            </div>
        </form>
    </div>
</div>
